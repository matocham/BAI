insert into users values (users_seq.nextval, 'user1','$2a$11$4Ttz61zmXVMhKD77.tvRsu6d0EvunMVam8da/o3We/p7E6eG34d.u', CURRENT_DATE, 0, null, 3);
insert into users values (users_seq.nextval, 'user2','$2a$11$rswUrzX32wkUIdouxS98Neq5Dt..6t14nuCXAP3RYKsEBalzthE72', CURRENT_DATE, 0, null, 3);
insert into users values (users_seq.nextval, 'user3','$2a$11$/JBVUb/kRleB8Pkb0X/DuOcUWVgBfjT8SRHPtqddkI8QyYWbg1BwK', CURRENT_DATE, 0, null, 3);
insert into users values (users_seq.nextval, 'user4','$2a$11$PHdBasedWvuIMFSlNEwk6OU92lWfiG/64SWz2vMLKZr76oIYH9Ke6', CURRENT_DATE, 0, null, 3);
